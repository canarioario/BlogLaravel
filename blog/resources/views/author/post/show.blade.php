...
@section('content')
    <div class="container-fluid">
        ...
        <a href="{{ route('author.post.index') }}" class="btn btn-danger waves-effect">ATRÁS</a>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              {{ $post->title }}
                                <small>Creado por <strong> <a href="">{{ $post->user->name }}</a></strong> on {{ $post->created_at->toFormattedDateString() }}</small>
                            </h2>
                        </div>
                        <div class="body">
                            {!! $post->body !!}
