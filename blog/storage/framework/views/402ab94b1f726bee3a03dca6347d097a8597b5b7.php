...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="<?php echo e(route('author.post.create')); ?>">
                <i class="material-icons">add</i>
                <span>Añadir nuevo Post</span>
            </a>
        </div>
        <!-- Exportable Table -->
                                    ...
                                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo e(route('author.post.show',$post->id)); ?>" class="btn btn-info waves-effect">
                                                    <i class="material-icons">visibility</i>
                                                </a>
                                                <a href="<?php echo e(route('author.post.edit',$post->id)); ?>" class="btn btn-info waves-effect">
