                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if($post->is_approved == false): ?>
                                                    <button type="button" class="btn btn-success waves-effect" onclick="approvePost(<?php echo e($post->id); ?>)">
                                                        <i class="material-icons">done</i>
                                                    </button>
                                                    <form method="post" action="<?php echo e(route('admin.post.approve',$post->id)); ?>" id="approval-form-<?php echo e($post->id); ?>" style="display: none">
                                                        <?php echo csrf_field(); ?>
