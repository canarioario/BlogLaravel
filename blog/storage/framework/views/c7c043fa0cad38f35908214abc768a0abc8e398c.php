                    ...
                    <div class="body">
                        <form action="<?php echo e(route('admin.category.update',$category->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="name" class="form-control" name="name" value="<?php echo e($category->name); ?>">
                            ...
                            <a  class="btn btn-danger m-t-15 waves-effect" href="<?php echo e(route('admin.category.index')); ?>">ATRÁS</a>
