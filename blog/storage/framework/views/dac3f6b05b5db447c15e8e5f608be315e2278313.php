...
<?php $__env->startSection('content'); ?>
               ...
               <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="swiper-slide">
                        <a class="slider-category" href="<?php echo e(route('category.posts',$category->slug)); ?>">
                            <div class="blog-image"><img src="<?php echo e(url('/storage/category/slider')); ?>/<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>"></div>
    ...
    <section class="blog-area section">
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <a class="avatar"><img src="<?php echo e(url('/storage/profile')); ?>/<?php echo e($post->user->image); ?>" alt="Profile Image"></a>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card h-100">
                            <div class="single-post post-style-1 p-2">
                               <strong>Ningún post encontrado :(</strong>
                            </div><!-- single-post -->
                        </div><!-- card -->
                    </div><!-- col-lg-4 col-md-6 -->
                <?php endif; ?>
            ...
            <a class="load-more-btn" href="<?php echo e(route('post.index')); ?>"><b>LEER MAS</b></a>
